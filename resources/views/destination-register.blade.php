...
<div class="pt-24 pb-16 min-h-screen bg-forest-50/50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {{-- Header Banner --}}
        <div class="bg-gradient-to-r from-forest-800 to-forest-950 rounded-3xl p-8 md:p-12 shadow-md text-white mb-8 relative overflow-hidden animate-fade-in" style="background: linear-gradient(135deg, #15803d 0%, #14532d 100%);">
            ...
            <div class="relative z-10">
                ...
                <h1 class="text-3xl md:text-5xl font-black text-white tracking-tight leading-none mb-3">Registrasi Online</h1>
                <p class="text-green-100 text-sm md:text-base max-w-2xl font-medium">Beli tiket masuk ke destinasi <strong>{{ $destination->name }}</strong> secara mandiri. Isi formulir pendaftaran di bawah ini.</p>
            </div>
        </div>
        ...
        <div class="grid lg:grid-cols-12 gap-8 items-start">
            ...
            <div class="lg:col-span-8">
                ...
                <div class="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-forest-100">
                    <h2 class="text-xl font-bold text-forest-950 mb-2 flex items-center gap-2 pb-4 border-b border-forest-50">
                        <i data-lucide="clipboard-edit" class="w-5 h-5 text-forest-600"></i> Formulir Data Pengunjung
                    </h2>
                    <div class="flex items-center gap-2 mb-6 text-sm text-forest-700 bg-forest-50 rounded-xl px-4 py-2.5 border border-forest-100">
                        <i data-lucide="calendar-check" class="w-4 h-4 text-forest-600 shrink-0"></i>
                        <span>Tanggal Kunjungan: <strong>{{ \Carbon\Carbon::parse($date)->translatedFormat('l, d F Y') }}</strong></span>
                        <a href="{{ route('destination.register.date', $destination->slug) }}" class="ml-auto text-[10px] text-forest-500 hover:text-forest-700 font-semibold underline">Ubah</a>
                    </div>

                    <form action="{{ route('destination.register.store', [$destination->slug, $date]) }}" method="POST" id="online-register-form">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="name" id="name" required placeholder="Masukkan nama penanggung jawab" class="w-full pl-12 pr-3 py-2.5 bg-white border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-forest-500 transition-all">
                                </div>
                            </div>

                            {{-- Jenis Kelamin Penanggung Jawab (Always visible) --}}
                            <div>
                                <label for="leader_gender" class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-2">Jenis Kelamin</label>
                                <div class="relative">
                                    <span class="absolute inset-y-0 left-0 pl-4 flex items-center text-gray-400">
                            ...
                            @if($destination->has_member_details)
                                    ...
                                    <div class="bg-[#f0fdf4] border border-green-100 rounded-xl p-4">
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div class="relative">
                                                    <div class="ts-icon-container"><i data-lucide="map" class="w-4 h-4"></i></div>
                                            ...
                                            <div>
                                                ...
                                                <div class="relative">
                                                    <div class="ts-icon-container"><i data-lucide="building" class="w-4 h-4"></i></div>
                                ...
                                <div class="col-span-1 md:col-span-2 border border-gray-200/80 rounded-2xl p-5 bg-gray-50/20 shadow-sm space-y-6">
                                    <div class="flex items-center justify-between border-b border-gray-200 pb-3">
                                        <div>
                                            <h4 class="font-bold text-forest-900 text-sm uppercase tracking-wider" style="margin:0;">Daftar Anggota Rombongan</h4>
                                            <p class="text-[11px] text-gray-400 font-normal mt-1" style="margin:0;">Isi data selain penanggung jawab. Satu tiket akan dicetak untuk setiap anggota.</p>
                                        </div>
                            ...
                            @if($destination->has_community)
                                <div class="col-span-1 md:col-span-2">
                                    <label for="community" class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-2">Nama Komunitas / Instansi</label>
                                    <div class="relative">
                                        <span class="absolute inset-y-0 left-0 pl-4 flex items-center text-gray-400">
                                            <i data-lucide="building" class="w-4.5 h-4.5"></i>
                                        </span>
                                        <input type="text" name="community" id="community" placeholder="Contoh: Mapala Sanggabuana, Universitas Karawang" class="w-full pl-12 pr-3 py-2.5 bg-white border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-forest-500 transition-all">
                                    </div>
                                </div>
                            @endif
                            ...
                            @if($destination->has_purpose)
                                <div class="col-span-1">
                                    ...
                                    <div class="relative">
                                        ...
                                        <select name="purpose" id="purpose" required class="w-full pl-12 pr-8 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-forest-500 transition-all appearance-none cursor-pointer bg-white">
                                ...
                                <div class="col-span-1" id="camping-duration-container">
                                    <label for="camping_duration" class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-2">Lama Camping <span class="text-[10px] text-gray-400 font-normal">(Malam)</span></label>
                                    <div class="relative">
                                        <span class="absolute inset-y-0 left-0 pl-4 flex items-center text-gray-400">
                                            <i data-lucide="moon" class="w-4.5 h-4.5"></i>
                                        </span>
                                        <input type="number" name="camping_duration" id="camping_duration" value="1" min="1" required class="w-full pl-12 pr-3 py-2.5 bg-white border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-forest-500 transition-all font-bold text-center">
                                    </div>
                                </div>
                            @endif
                            ...
                            @if(!$destination->has_member_details)
                            <div>
                                <label for="address_type" class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-2">Kategori Wilayah Asal</label>
                                <div class="relative">
                                    <span class="absolute inset-y-0 left-0 pl-4 flex items-center text-gray-400">
                                    ...
                                    <select name="address_type" id="address_type" required class="w-full pl-12 pr-8 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-forest-500 transition-all appearance-none cursor-pointer bg-white">
                                        ...
                                        <option value="indonesia" selected>Domestik / Nusantara</option>
                            ...
                            {{-- Province --}}
                            <div>
                                <label for="province" id="lbl_province" class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-2">Provinsi</label>
                                <input type="hidden" name="province" id="province_hidden">
                            ...
                            {{-- City --}}
                            <div class="col-span-1 md:col-span-2">
                                <label for="city_input" id="lbl_city" class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-2">Kota / Kabupaten</label>
                                <input type="hidden" name="city" id="city_hidden">
                            ...
                            @if(!$destination->has_member_details)
                                {{-- Group Average Age --}}
                                <div>
                                    <label for="avg_age" class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-2">Rata-rata Usia</label>
                                    <div class="relative">
                                        <span class="absolute inset-y-0 left-0 pl-4 flex items-center text-gray-400">
                                            <i data-lucide="calendar" class="w-4.5 h-4.5"></i>
                                        </span>
                                ...
                                <div class="col-span-1 md:col-span-2 border border-gray-150 rounded-2xl overflow-hidden shadow-sm transition-all duration-300">
                                    <button type="button" id="toggle-rombongan-accordion" class="w-full flex items-center justify-between p-4 bg-gray-50/60 hover:bg-gray-100/60 transition-colors focus:outline-none select-none">
                                        <div class="flex items-center gap-2 text-left">
                                            <div>
                                                ...
                                                <p class="text-[10px] text-gray-400 font-normal normal-case leading-none my-0.5">
                                                ...
                                                <div class="flex items-center mt-2">
                                                    ...
                                                    <i id="accordion-chevron" data-lucide="chevron-down" class="w-4 h-4 text-gray-400 transition-transform duration-300 ml-1"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </button>
                                    ...
                                    <div id="rombongan-accordion-content" class="max-h-0 overflow-hidden transition-all duration-300 ease-in-out bg-white" style="max-height: 0px;">
                                        <div class="p-4 flex flex-col gap-4 border-t border-gray-100">
                                            <div class="grid grid-cols-3 gap-4">
                                                <div>
                                                    <label for="qty_male" class="block text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-1">Laki-laki</label>
                                                    <input type="number" name="qty_male" id="qty_male" value="0" min="0" required class="w-full py-2 bg-white border border-gray-200 rounded-xl text-sm font-bold text-center focus:outline-none focus:border-forest-500">
                                                </div>
                                                <div>
                                                    <label for="qty_female" class="block text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-1">Perempuan</label>
                                                    <input type="number" name="qty_female" id="qty_female" value="0" min="0" required class="w-full py-2 bg-white border border-gray-200 rounded-xl text-sm font-bold text-center focus:outline-none focus:border-forest-500">
                                                </div>
                                                <div>
                                                    <label for="qty_kids" class="block text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-1">Anak-anak</label>
                                                    <input type="number" name="qty_kids" id="qty_kids" value="0" min="0" required class="w-full py-2 bg-white border border-gray-200 rounded-xl text-sm font-bold text-center focus:outline-none focus:border-forest-500">
                                                </div>
                                            </div>
                                            <div class="bg-gray-50 border border-gray-200 rounded-xl px-4 py-2 text-xs text-gray-500 flex justify-between items-center">
                                                <span>Total Pengunjung:</span>
                                                <span class="font-extrabold text-forest-750 text-sm"><span id="gunung-calc-total">1</span> Orang</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div>
                                <label class="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-2">Harga Per Tiket (HTM)</label>
                                <div class="relative">
                                    <span class="absolute inset-y-0 left-0 pl-4 flex items-center text-gray-500">
                                        <i data-lucide="banknote" class="w-4.5 h-4.5"></i>
                                    </span>
                                    <input type="text" disabled value="Rp {{ number_format($destination->price, 0, ',', '.') }}" class="w-full pl-12 pr-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm font-bold text-gray-600">
                                </div>
                            </div>
                        ...
                        <div class="mt-8 pt-6 border-t border-forest-50 flex flex-col sm:flex-row items-center justify-between gap-4">
                            ...
                            <button type="submit" class="w-full sm:w-auto px-8 py-3.5 bg-forest-600 hover:bg-forest-750 text-white font-bold rounded-xl transition-all shadow-md hover:shadow-forest-500/20 flex items-center justify-center gap-2">
            ...
            <div class="lg:col-span-4 space-y-6">
                ...
                @if(session('print_ticket_ids') || session('print_ticket_id'))
                    @php
                        $ticketIds = session('print_ticket_ids') ? session('print_ticket_ids') : [session('print_ticket_id')];
                        ...
                        <div class="relative overflow-hidden rounded-3xl shadow-md border border-green-200/60 bg-white">
                            ...
                            <div class="bg-gradient-to-r from-emerald-600 to-forest-700 px-6 py-4 flex items-center justify-between" style="background: linear-gradient(135deg, #059669 0%, #15803d 100%);">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h4 class="font-extrabold text-white text-xs tracking-wide uppercase">Tiket Aktif! ({{ $index + 1 }}/{{ count($printedTickets) }})</h4>
                            ...
                            <div class="p-6 space-y-4">
                                <div class="text-center pb-4 border-b border-dashed border-gray-150">
                                    ...
                                    <div class="font-black text-gray-900 text-xl tracking-tight mt-1">{{ $printedTicket->ticket_no }}</div>
                                </div>
                                ...
                                <div class="space-y-2.5 text-xs text-gray-600">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <strong class="text-gray-800">{{ $printedTicket->age }} Tahun</strong>
                                    </div>
                                    @endif
                                    <div class="flex justify-between">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <strong class="text-gray-800">{{ $printedTicket->payment_method }}</strong>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-400">Total Harga:</span>
                                        <strong class="text-forest-700 font-extrabold">Rp {{ number_format($printedTicket->total_price, 0, ',', '.') }}</strong>
                                    </div>
                                </div>
                            ...
                            {{-- Print button --}}
                            <div class="bg-gray-50 border-t border-dashed border-gray-150 px-6 py-3 text-center">
                                <button type="button" onclick="window.print()" class="text-xs text-forest-600 hover:text-forest-800 font-bold flex items-center justify-center gap-1.5 mx-auto transition-colors">
                ...
                @else
                    ...
                    <div class="bg-white rounded-3xl p-6 shadow-sm border border-forest-100 text-center space-y-4">
                        <div class="w-14 h-14 bg-forest-50 text-forest-600 rounded-full flex items-center justify-center mx-auto">
                        ...
                        <p class="text-xs text-forest-600 leading-relaxed text-left">
                            ...
                            4. Klik <strong>Proses Registrasi</strong>. Tiket elektronik Anda beserta QR Code akan muncul seketika di bagian ini setelah transaksi berhasil diproses. Silakan simpan / cetak tiket tersebut.
                        </p>
                    </div>
                @endif
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (provinceSelect) {
                tsProvince = new TomSelect(provinceSelect, {
                    ...
                    onChange: function(value) {
                        ...
                        const activeType = leaderAddressTypeEl ? leaderAddressTypeEl.value : (addressTypeSelect ? addressTypeSelect.value : 'indonesia');
            ...
            async function loadProvinces() {
                ...
                try {
                    ...
                    tsProvince.clearOptions();
                    data.forEach(p => tsProvince.addOption({value: p.name, text: p.name, id: p.id}));
                    tsProvince.enable();
                } catch (e) { tsProvince.enable(); }
            }
            ...
            async function loadCities(provinceId) {
                ...
                try {
                    ...
                    const data = await res.json();
                    tsCity.clearOptions();
                    data.forEach(c => tsCity.addOption({value: c.name, text: c.name}));
                    tsCity.enable();
                } catch (e) { tsCity.enable(); }
            }
            ...
            async function loadCountries() {
                ...
                try {
                    ...
                    tsProvince.clearOptions();
                    if (json) json.forEach(c => tsProvince.addOption({value: c.name, text: c.name}));
                    tsProvince.enable();
                    tsCity.clearOptions(); tsCity.enable();
                } catch (e) { tsProvince.enable(); }
            }
            ...
            function handleAddressTypeChange() {
                ...
                if (type === 'lokal') {
                    ...
                    tsProvince.enable(); tsProvince.wrapper.style.pointerEvents = ''; tsProvince.wrapper.style.opacity = '';
                    tsCity.enable(); tsCity.wrapper.style.pointerEvents = ''; tsCity.wrapper.style.opacity = '';
                    loadProvinces();
